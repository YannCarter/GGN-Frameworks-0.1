...
======================================================
	CLASS imagesJPEG
	PAGE cores/_natives/PHP/Register.core.g/ARC_ENGINE_RENDING/.JPEG/imagesJPEG.arc-render.php
======================================================

	Moteur de rendu d'images JPEG
		...
		if($Cache->HashChanged==true){
			...
			$Data = GGN\Caches\Tmp::Data($CacheName, function($path) use ($Render, $resizer, $resizeby, $rogner){
				...
				if($resizer===true){
					...
					$Render->resize($path, $resizeby, $rogner);	
