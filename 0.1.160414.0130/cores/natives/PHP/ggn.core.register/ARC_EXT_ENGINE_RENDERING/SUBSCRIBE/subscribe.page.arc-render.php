...
/* Activation */
if(\_native::varn('SUBSCRIBEPAGE_ACTIVE') == 0){
...
// 	else{
		...
		$tpl->head->title(\_native::varn('SUBSCRIBEPAGE_TITLE'))
		...
		*/
		...
		$tpl->body->sheet->text(\Gougnon::fullSpace('<center><h1>Page d\'inscription</h1></center>'));
